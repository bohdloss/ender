...
use crate::{BitWidth, Endianness, impl_error, NumEncoding, StrEncoding};
...
pub enum BorrowError {
	...
	Unsupported,
	#[display("String encoding mismatch: expected {found} while decoding a {while_decoding} string")]
	StrEncodingMismatch {
		found: StrEncoding,
	...
	NonBorrowableNumEncoding {
		num_encoding: NumEncoding,
	},
	#[display("Alignment mismatch: borrowing this data requires its alignment to match the system's")]
	AlignmentMismatch,
}
