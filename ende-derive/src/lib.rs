...
/// If the key or iv are not specified, they will be inferred from the [`ende::encryption::CryptoState`]
/// * `#[ende(encrypted = "{key_size}-bit (rev)RSA/{mode}/{padding}", key: key)]` - Variant
/// of the above that uses RSA encryption, and only works with [`ende::encryption::RsaBlock`]<br>
/// <br>
/// Example:
/// ```ignore
/// use ende::{Encode, Decode};
...
///     #[ende(encrypted = "2048-bit RSA/ECB/PKCS1", key: super_extra_secret_rsa_key)]
///     even_more_secret_data: RsaBlock,
/// }
/// ```
/// Helpers change how a field is encoded/decoded and only apply to Fields.<br>
/// * `#[ende(serde)]` - Field will be serialized/deserialized with a serde compatibility layer
...
/// Helper macro to derive ende::Decode for a `struct` or `enum`<br>
/// This macro supports a series of helper flags to aid customization<br>
/// <br>
/// All flags follow the following format:<br>
/// `#[ende(flag1; flag2; flag2; ...)]`<br>
